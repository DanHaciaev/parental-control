...
fun DevicePairingScreen(
    ...
    LaunchedEffect(uiState.devicePaired) {
        if (uiState.devicePaired) onPaired()
    }
    ...
    Column(
        ...
        Text(
            text = "Привяжите ноутбук ребёнка",
            style = MaterialTheme.typography.headlineMedium,
            textAlign = TextAlign.Center
        )
        Spacer(Modifier.height(12.dp))
        Text(
            text = "Запустите NestKidSetup на ноутбуке ребёнка и введите там этот код. Код действует 15 минут.",
        ...
        Spacer(Modifier.height(24.dp))
        Text(
            text = "Ждём подключение ноутбука…",
            style = MaterialTheme.typography.bodyLarge,
